            ...
            try {
              ...
              if (data.type === 'message' && data.chatJid && data.text) {
                ...
                if (
                  ...
                  const hostPath = (data.imagePath as string).startsWith('/workspace/group/')
                    ? path.join(GROUPS_DIR, sourceGroup, (data.imagePath as string).slice('/workspace/group/'.length))
